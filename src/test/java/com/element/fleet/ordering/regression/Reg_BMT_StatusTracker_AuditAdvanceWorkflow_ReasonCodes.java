 ...
 */
public class Reg_BMT_StatusTracker_AuditAdvanceWorkflow_ReasonCodes extends BaseWebDriver {
	...
	public void searchFunctionality() throws Throwable {
		OrderingBMTStatusTrackerPage.searchRecords("Reason Code Category", "Audit Advanced Workflow Codes");
