 ...
 */
public class Reg_BMT_StatusTracker_Delivery_ReasonCodes extends BaseWebDriver {
	...
	public void searchFunctionality() throws Throwable {
		OrderingBMTStatusTrackerPage.searchRecords("Reason Code Category", "Delivery Codes");
