 ...
 */
public class Reg_BMT_StatusTracker_TruckAndEquipments_ReasonCodes extends BaseWebDriver {
	...
	public void searchFunctionality() throws Throwable {
		OrderingBMTStatusTrackerPage.searchRecords("Reason Code Category", "Trucks/Equipment Codes");
