 ...
 */
public class Reg_BMT_StatusTracker_Upfitting_ReasonCodes extends BaseWebDriver {
	...
	public void searchFunctionality() throws Throwable {
		OrderingBMTStatusTrackerPage.searchRecords("Reason Code Category", "Upfitting Codes");
