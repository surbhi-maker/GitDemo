 ...
 */
public class Reg_BMT_StatusTracker_VendorPayment_ReasonCodes extends BaseWebDriver {
	...
	public void searchFunctionality() throws Throwable {
		OrderingBMTStatusTrackerPage.searchRecords("Reason Code Category", "Vendor Payment Codes");
