 ...
 */
public class Reg_DA_EDDAR_Add_Rule extends BaseWebDriver {
	...
	@Documentation(step = "EDDAR Page label validation", expected = "Application should be able to validate all labels of EDDAR page")
	...
	@Documentation(step = "click on add rule button and verify whether the add rule page gets open", expected = "Add Rule page got loaded")
