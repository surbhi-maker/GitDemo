 ...
 */
public class Reg_DIO_Validate_NVAC_User_Can_Not_Add_Delete_DIO_For_MSO_Received_Order extends BaseWebDriver {
	...
	@Documentation(step = "Open Back office page", expected = "Back office page should be opened")
	public void testLaunchBOURLAsNVACUser() throws Throwable {
		OrderingLoginPage.openBOApplication();
	}

	@Test(dependsOnMethods = "testLaunchBOURLAsNVACUser")
	@Documentation(step = "Enter the valid username and password to login to the application", expected = "The application home page should be displayed after successful login")
	public void testLoginBOApplicationAsNVACUser() throws Throwable {
		
		OrderingBOHomePage.orderingBOHomePageLoaded();
	}
	
	@Test(dependsOnMethods = "testLoginBOApplicationAsNVACUser")
	...
	@Documentation(step = "Validate Warning message is displayed as expected", expected = "Warning message should be displayed as expected")
	public void validateWarningPopupMessage() throws Throwable {
		OrderingBOOnOrderQueuePage.validateDIOErrorMessage();
	}
	
	@Test(dependsOnMethods = "validateWarningPopupMessage")
	@Documentation(step = "Validate that Warning popup closed on clicking Cancel button", expected = "Warning popup should close on clicking cancel button")
	public void validatePopupClosesOnClickingCancelButton() throws Throwable {
		OrderingBODealerInstalledOptionsPage.clickCancelWarningPopup();
		OrderingBODealerInstalledOptionsPage.validateDIOWarningMessageIsClosed();
	}
	
	@Test(dependsOnMethods = "validatePopupClosesOnClickingCancelButton")
	@Documentation(step = "Validate that Warning popup closed on clicking Ok button", expected = "Warning popup should close on clicking Ok button")
	public void validatePopupClosesOnClickingOkButton() throws Throwable {
		OrderingBODealerInstalledOptionsPage.clickDIOSearch();
		OrderingBODealerInstalledOptionsPage.validateDIOWarningMessage();
		OrderingBODealerInstalledOptionsPage.clickOkWarningPopup();
		OrderingBODealerInstalledOptionsPage.validateDIOWarningMessageIsClosed();
	}
	
	@Test(dependsOnMethods = "validatePopupClosesOnClickingOkButton")
	@Documentation(step = "click on Logout button", expected = "Application should be logged out")
