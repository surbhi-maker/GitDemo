 ...
 */
public class Reg_DealerQueue_Search_Sort_ToggleColumn_ClearFilter_Export extends BaseWebDriver {
	...
	public void verifyDealerQueuePageSearchAndSortFunctionality() throws Throwable {
		OrderingBOQueuePage.verifyReleaseButton(true);
		OrderingBOQueuePage.searchAndVerifyRecords("Standard Search", "Client", "9990");
	}
	
	@Test(dependsOnMethods = "verifyDealerQueuePageSearchAndSortFunctionality")
	@Documentation(step = "Go to On Dealer Queue page and verify Toogle and Queue Table columns", expected = "Application should show the Queue table columnd are same as toggle columns On DIO Queue page")
	...
	public void verifyExportTableData() throws Throwable {
		OrderingSummaryPage.clickExportButton("DealerQueue", this.getClass().getSimpleName());
	}
	...
	public void verifyColumnSortedInDescAscOrder() throws Exception {
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Log", "DealerQueue");
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Log", "DealerQueue");
		OrderingBOOnOrderQueuePage.compareOrderOfColumn("Log", "Ascending" , "DealerQueue");
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Client", "DealerQueue" );
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Client", "DealerQueue" );
		OrderingBOOnOrderQueuePage.compareOrderOfColumn("Client", "Ascending" , "DealerQueue");
	}
