 ...
 */
public class Reg_Dealer_Telematics_DIO_Upfit extends BaseWebDriver {
	...
	public void verifyTelematicsStatus() throws Exception {
		OrderingBOOrdMaintPage.validateTelematicsIndicator("No");	
	}
	
	@Test(dependsOnMethods = "verifyTelematicsStatus")
	@Documentation(step = "acknowledge the Order", expected = "User should be able to Acknowledge the Order")
	public void verifyOrderInTelematicsQueue() throws Exception {
		...
		OrderingBOTelematicsQueuePage.VerifyOrderNotPresentInTelematicsQueue();
	}
	
	@Test(dependsOnMethods = "verifyOrderInTelematicsQueue")
