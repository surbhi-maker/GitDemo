 ...
 */
public class Reg_EditOrder_Dealer_AutoUnit_FleetSpec_DifferentDealer extends BaseWebDriver {
	...
	public void selectBillingLease() throws Exception {
		...
		OrderingBillingAndRegistrationPage.verifyPlateTypeDrpDwnValues();
		OrderingBillingAndRegistrationPage.verifyWhoToTitleDrpDwnValues();
	}
