...
/**
 * @lastModifiedBy Mayur
 */
public class Reg_Factory_BmtDIO_Add_Delete extends BaseWebDriver {
	...
	public void selectVehicleFleetSpec() throws Exception {
		OrderingStartHerePage.clickSaveAndNext();
		OrderingVehiclePage.enterDetailsVehicleWithAddDeleteOperations();
	}
	...
	@Documentation(step = "Go to Manager order prefrences", expected = "Application should load On Manager order prefrences")
	public void selectOption() throws Throwable {
		...
		OrderingBOBusinessMaintainedTablesPage.addNewDIO();
	}
	...
	@Documentation(step = "Go to On DIOTab page", expected = "DIO tab should be selected")
	public void validateDIOTabInfo() throws Throwable {
		OrderingBOOrdMaintPage.verifyBODIOTab();
		OrderingBOOrdMaintPage.verifyDIODelete();
		OrderingBOOrdMaintPage.verifyDIOAdd();
	}
	
	@Test(dependsOnMethods = "goToOnOrderQueuePage")
	@Documentation(step = "Go to On DIOTab page", expected = "DIO tab should be selected")
	public void goToOnOrderQueuePageAfterDIO() throws Throwable {	
		OrderingBOQueuePage.gotoCreatedOrder();
	}
	
	@Test(dependsOnMethods = "goToOnOrderQueuePageAfterDIO")
