...
import com.element.fleet.ordering.page.OrderingBOTelematicsQueuePage;
 ...
 */
public class Reg_Factory_Telematics_DIO_Upfit extends BaseWebDriver {
	...
	public void verifyTelematicsIndicator() throws Throwable {
		OrderingBOOrdMaintPage.validateTelematicsIndicator("No");
	}
	
	@Test(dependsOnMethods = "verifyTelematicsIndicator")
	@Documentation(step = "Check error if there is any soft error", expected = "Resolve all the soft errors")
	...
	public void goToVehicleQueuePage() throws Exception {
	...
	public void acknowledgeOrder() throws Exception {
		OrderingBOOrdMaintPage.acknowledgeOrder();
	}
	
	@Test(dependsOnMethods = "acknowledgeOrder")
	@Documentation(step = "acknowledge the Order", expected = "User should be able to Acknowledge the Order")
	public void verifyOrderAndTelematicsStatus() throws Exception {
		OrderingBOOrdMaintPage.verifyChangedOrderStatus("AY0030 - Telematics Open");
		OrderingBOOrdMaintPage.validateTelematicsIndicator("Yes");	
	}
	
	@Test(dependsOnMethods = "verifyOrderAndTelematicsStatus")
	@Documentation(step = "acknowledge the Order", expected = "User should be able to Acknowledge the Order")
	public void releaseOrderFromTeleMaticsQueue() throws Throwable {
		OrderingBOOrdMaintPage.goBackToQueuesPage();
		OrderingBOQueuePage.queuePageLoaded();
		OrderingBOQueuePage.gotoQueue("Telematics");
		OrderingBOTelematicsQueuePage.waitForTelematicsPageToLoad();
		OrderingBOTelematicsQueuePage.releaseOrder();
	}
	
	@Test(dependsOnMethods = "releaseOrderFromTeleMaticsQueue")
	@Documentation(step = "acknowledge the Order", expected = "User should be able to Acknowledge the Order")
	public void verfiyChangedOrderStatus() throws Exception {
		OrderingBOQueuePage.gotoCreatedOrder();
		OrderingBOOrdMaintPage.verifyChangedOrderStatus("AY0040 - Telematics Released");
		OrderingBOOrdMaintPage.validateTelematicsIndicator("Yes");	
	}
	
	@Test(dependsOnMethods = "verfiyChangedOrderStatus")
