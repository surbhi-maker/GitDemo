 ...
 */
public class Reg_Factory_Validate_Deny_CreditOrder extends BaseWebDriver {
	...
	@Documentation(step = "Check error if there is any soft error and deny credit error", expected = "Resolved all the soft errors and denied credit error")
	public void resolveAllTheSoftErrorAndDenyCreditError() throws Throwable {
		...
		OrderingBOOrdMaintPage.checkAndRemoveAllSoftApprovalErrorsIfPresentAndDenyCreditError();
	}
	
	@Test(dependsOnMethods = "resolveAllTheSoftErrorAndDenyCreditError", alwaysRun = true)
