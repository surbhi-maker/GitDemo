 ...
 */
public class Reg_FleetSpecification_Bulk_FlagForReview_ApproveDecline_DPOThreshold extends BaseWebDriver {
	...
	public void searchWithPendingClientApprovalAndValidate() throws Exception{
		...
		OrderingCommonPage.checkGlobalSpinnerPopUp();
		OrderingVehicleConfigFleetSpecsPage.validateColumnValue(1, "Fleet Spec Status", "Pending Customer Approval");	
	}
	...
	public void validateFlaggedForReview() throws Exception{
		...
		OrderingVehicleConfigFleetSpecsPage.clickOnSearch();
		OrderingCommonPage.checkGlobalSpinnerPopUp();
		CommonPage.getElementOrderObject().getVehicleTabObject().setFleetSpecID(OrderingVehicleConfigFleetSpecsPage.returnColumnValue(1, "Fleet Spec ID"));
		OrderingVehicleConfigFleetSpecsPage.selectActionFromList(1,"Flag For Review");
		OrderingCommonPage.checkGlobalSpinnerPopUp();
		OrderingVehicleConfigFleetSpecsPage.clickOnClearFilters();
		OrderingCommonPage.checkGlobalSpinnerPopUp();
		OrderingVehicleConfigFleetSpecsPage.enterOrSelectFieldValue("Client Number", CommonPage.getTestData("ClientNumber"));
		OrderingVehicleConfigFleetSpecsPage.enterOrSelectFieldValue("Fleet Spec Id",CommonPage.getElementOrderObject().getVehicleTabObject().getFleetSpecID());
		OrderingVehicleConfigFleetSpecsPage.clickOnSearch();
		OrderingCommonPage.checkGlobalSpinnerPopUp();
		...
		OrderingVehicleConfigFleetSpecsPage.clickOnSearch();
		OrderingCommonPage.checkGlobalSpinnerPopUp();
		OrderingVehicleConfigFleetSpecsPage.validateFlaggedForReviewStatusRedBar(BrowserAccess.getElements(OrderingVehicleConfigFleetSpecsPageEnum.ORDERING_SEARCH_SPEC_TABLE_COLUMNS_XPATH).size(),1,"#BF2E2E");
	}
	...
	public void validateSearchWithFlaggedForReviewYes() throws Exception{
		...
		OrderingVehicleConfigFleetSpecsPage.clickOnSearch();
		OrderingCommonPage.checkGlobalSpinnerPopUp();
		System.out.println(BrowserAccess.getElements(OrderingVehicleConfigFleetSpecsPageEnum.ORDERING_SEARCH_SPEC_TABLE_COLUMNS_XPATH).size());
	...
	public void validateRemoveFlaggedForReview() throws Exception{
		...
		OrderingVehicleConfigFleetSpecsPage.clickOnSearch();
		OrderingCommonPage.checkGlobalSpinnerPopUp();
		OrderingVehicleConfigFleetSpecsPage.validateFlaggedForReviewStatusRedBar(28,1,"None");
	...
	public void validateButtonsForSpecWithPendingClientApproval() throws Exception{
		...
		OrderingVehicleConfigFleetSpecsPage.validatePresenceofDeclineAndApproveButtonsForGivenFleetSpec(CommonPage.getElementOrderObject().getVehicleTabObject().getFleetSpecID());
	}
	...
	public void clickDeclineButtonAndVerifyPopUpIsdisplayed() throws Exception{
	...
	@Test(dependsOnMethods = "clickDeclineButtonAndVerifyPopUpIsdisplayed")
