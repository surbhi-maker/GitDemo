 ...
 */
public class Reg_MF_Status_FactoryOrder_Add_Remove_UsedUnit extends BaseWebDriver {
    ...
    public class BO_RemoveUsedUnit extends BaseWebDriver{
		...
		@Documentation(step = "Go to On Order Queue page", expected = "Application should load On Order Queue page")
		public void removeUsedUnit() throws Throwable {
			OrderingBOOrdMaintPage.removeUsedUnitFromOrder();
		}

		@Test(dependsOnMethods = "removeUsedUnit")
		@Documentation(step = "validate bridging table of Ordering DB", expected = "Bridging table should be updated with the expected column values")
		public void bridgingDBValidationCancelOrder() throws Exception {
			OrderingMFStatusValidation.removeUsedUnitOrderBridgingTableDataValidation();
		}
