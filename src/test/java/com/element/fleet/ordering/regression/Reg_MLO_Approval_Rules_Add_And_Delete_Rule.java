 ...
 * @lastModifiedBy Usha
 */
public class Reg_MLO_Approval_Rules_Add_And_Delete_Rule extends BaseWebDriver{
	...
	public void deleteApprovalRule() throws Exception {
		OrderingBOManagerOrderPreferencesPage.clickOnDeleteButton("Approval Rules");
	...
	@Test(dependsOnMethods = "deleteApprovalRule", alwaysRun = true)
