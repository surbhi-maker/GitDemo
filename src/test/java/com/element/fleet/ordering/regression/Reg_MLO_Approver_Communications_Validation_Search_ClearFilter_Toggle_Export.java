 ...
 */
public class Reg_MLO_Approver_Communications_Validation_Search_ClearFilter_Toggle_Export  extends BaseWebDriver {
	...
	public void clearFiltersApprovalRules() throws Exception {		
		OrderingBOManagerOrderPreferencesPage.verifyClearFilters("Approval Communications");
	}
	...
	public void verifyAllColumnsAreAvailable() throws Exception {
		OrderingBOManagerOrderPreferencesPage.clickOnToggleButton("Approval Communications");
	...
	public void verifyExportFunctionality() throws Exception {
		OrderingBOManagerOrderPreferencesPage.verifyExportCSV("approver-communications-queue", this.getClass().getSimpleName());
	}
