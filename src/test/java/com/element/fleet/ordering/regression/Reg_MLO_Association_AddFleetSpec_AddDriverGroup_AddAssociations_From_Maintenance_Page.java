 ...
 */
public class Reg_MLO_Association_AddFleetSpec_AddDriverGroup_AddAssociations_From_Maintenance_Page extends BaseWebDriver {
	...
	public static void addFleetSpecGrpFromMaintanance() throws Exception {
		OrderingBOHomePage.selectSideMenuOption("Manager Order Preferences");
		OrderingBOManagerOrderPreferencesPage.waitForManagerOrderPreferencesPageToLoaded();
		OrderingBOManagerOrderPreferencesPage.moveToSection("Associations");
	...
	@Test(dependsOnMethods = "addFleetSpecGrpFromMaintanance")
	@Documentation(step = "Adds driver group to existing association", expected = "Driver group should be added succesfully")
	public static void addDrivercGrpFromMaintanance() throws Exception {
		OrderingBOManagerOrderPreferencesPage.selectGroupFromAssocMaintanancePage("Driver Groups");
	}
	
	@Test(dependsOnMethods = "addDrivercGrpFromMaintanance", alwaysRun = true)
