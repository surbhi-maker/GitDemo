 ...
 */
public class Reg_MLO_Association_Validation_Search_ClearFilter_Toggle_Export extends BaseWebDriver {
	...
	public void clearFiltersApprovalRules() throws Exception {		
		OrderingBOManagerOrderPreferencesPage.verifyClearFilters("Associations");
	}
	...
	public void verifyAllColumnsAreAvailable() throws Exception {
		OrderingBOManagerOrderPreferencesPage.clickOnToggleButton("Associations");
	...
	public void verifyExportFunctionality() throws Exception {
		OrderingBOManagerOrderPreferencesPage.verifyExportCSV("associations-queue", this.getClass().getSimpleName());
	}
