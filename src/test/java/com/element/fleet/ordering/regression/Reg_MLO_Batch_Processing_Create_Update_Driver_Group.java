 ...
 */
public class Reg_MLO_Batch_Processing_Create_Update_Driver_Group extends BaseWebDriver {
	...
	public void goToCreateDriverGroupPage() throws Exception {
		...
		OrderingBOBatchProcessingDriverGroupPage.batchProcessingCreateDriverGroupPageLoaded();
	}
	...
	public void downloadAddBatchTemplate() throws Exception {
		OrderingBOBatchProcessingDriverGroupPage.downloadCreateDriverGroupBatchTemplate("BatchDriverGroupAddDGATemplate");
	}
	...
	public void addDataInCreateDriverGroupBatchTemplate() throws Exception {
		...
		OrderingBOBatchProcessingDriverGroupPage.writeDataToExcel(System.getProperty("user.dir")+"\\target\\", "DriverGroup_BatchTemplate_BatchDriverGroupAddDGATemplate.xlsx", "Sheet1");
	}
	...
	public void uploadAddBatchTemplate() throws Exception {
		OrderingBOBatchProcessingDriverGroupPage.uploadCreateDriverGroupBatchTemplate(driver);
	}		
	...
	public void searchAndVerifyCreatedDriverGroup() throws Exception {
		OrderingBOManagerOrderPreferencesPage.searchAndSelectOnTheDriverGroup();
		OrderingBOManagerOrderPreferencesPage.verifyCreatedDriverGroup("2");
	}	
	
	@Test(dependsOnMethods = "searchAndVerifyCreatedDriverGroup")
	@Documentation(step = "Go to Driver Group Maintenance page", expected = "Driver Group Maintenance page should be loaded")
	public void goToDriverGroupMaintenancePage() throws Exception {
		System.out.println("Navigating to Driver Group Maintenance page under Batch Processing");
		OrderingBOHomePage.selectSideMenuOption("Batch Processing");
		OrderingBOHomePage.batchProcessingSideMenuOptionsLoaded();
		...
		OrderingBOBatchProcessingDriverGroupPage.batchProcessingDriverGroupMaintenancePageLoaded();
		OrderingBOBatchProcessingDriverGroupPage.batchProcessingDriverGroupMaintenancePageLabelValidation();
	}

	@Test(dependsOnMethods = "goToDriverGroupMaintenancePage")
	@Documentation(step = "Download Mass Update Driver Group Batch Template", expected = "Mass Update Driver Group Batch Template should be downloaded successfully")
	public void downloadUpdateBatchTemplate() throws Exception {
		OrderingBOBatchProcessingDriverGroupPage.downloadUpdateDriverGroupBatchTemplate("BatchDriverGroupMassUpdateDGMUTemplate");
	}		
	
	@Test(dependsOnMethods = "downloadUpdateBatchTemplate")
	@Documentation(step = "Add Data in Update Driver Group Batch Excel Template", expected = "Data should get added successfully")
	public void addDataInUpdateDriverGroupBatchTemplate() throws Exception {
		OrderingBOBatchProcessingDriverGroupPage.updateDriverDataMap();
		OrderingBOBatchProcessingDriverGroupPage.writeDataToExcel(System.getProperty("user.dir")+"\\target\\", "DriverGroup_BatchTemplate_BatchDriverGroupMassUpdateDGMUTemplate.xlsx", "Sheet1");
	}
	
	@Test(dependsOnMethods = "addDataInUpdateDriverGroupBatchTemplate")
	@Documentation(step = "Upload Update Driver Group Batch Template", expected = "Update Driver Group Batch Template should be uploaded successfully")
	public void uploadUpdateBatchTemplate() throws Exception {
		OrderingBOBatchProcessingDriverGroupPage.uploadUpdateDriverGroupBatchTemplate(driver);
	}
	
	@Test(dependsOnMethods = "uploadUpdateBatchTemplate")
	@Documentation(step = "Search and verify updated Driver Group", expected = "Updated Driver Group should be returned on search")
	public void searchAndVerifyUpdatedDriverGroup() throws Exception {
		System.out.println("Navigate to Manager Order Preferences page");
		OrderingBOHomePage.selectSideMenuOption("Manager Order Preferences");
		OrderingBOManagerOrderPreferencesPage.waitForManagerOrderPreferencesPageToLoaded();
		OrderingBOManagerOrderPreferencesPage.moveToSection("Driver Groups");
		OrderingBOManagerOrderPreferencesPage.searchAndSelectOnTheDriverGroup();
		OrderingBOManagerOrderPreferencesPage.verifyCreatedDriverGroup("3");
	}
	
	@Test(alwaysRun = true, dependsOnMethods = "searchAndVerifyUpdatedDriverGroup")
