 ...
 */
public class Reg_MLO_External_User_Reject_Order extends BaseWebDriver {
	@BeforeClass
	...
	@Documentation(step = "Expected Approver  reject the order, ORD-22214", expected = " Order should be rejected")
	public void verifyExpectedApproverCanRejectOrder() throws Throwable {
		...
		OrderingManagerApprovalQueuePage.performOrderAction("Reject", false);
		OrderingHomePage.verifyLogOutFunctionality();
	}
	
	@Test(dependsOnMethods = "verifyExpectedApproverCanRejectOrder")
	...
	@Documentation(step = "Super users validates that external user has rejected the order, ORD-22214", expected = "Order should not display in MAM screen")
