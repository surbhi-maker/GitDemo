 ...
 */
public class Reg_MLO_External_User_Reject_Order_With_SuperUser extends BaseWebDriver {
	@BeforeClass
	...
	@Documentation(step = "Super users rejects the order, ORD-22115", expected = "Order should be rejected")
	public void rejectGivenOrder() throws Throwable {
	OrderingManagerApprovalMaintenancePage.cancelOrder();
	} 
	...
	@Documentation(step = "External user verifies that order is not present in queue, ORD-22210", expected = "ORder should not display in queue" )
