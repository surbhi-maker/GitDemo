 ...
 * tests ORD-22211
 */
public class Reg_MLO_Factory_Resolution_Role_Approval extends BaseWebDriver {
	@BeforeClass
	...
	@Documentation(step = "Navigate to MAM queue screen", expected = "Manager approval queue screen should display" )
	...
	@Documentation(step = "Expected Approver  with factory resolution role logs and approves the order, ORD-22211", expected = " Order should be approved by Approver User and order should be removed from list")
	...
	@Documentation(step = "Super users validates that approval submitted by expected approver is shown", expected = "Order should show expected approver as complete")
