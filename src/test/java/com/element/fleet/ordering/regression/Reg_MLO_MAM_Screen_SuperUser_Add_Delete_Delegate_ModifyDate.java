 ...
 * @lastModifiedBy usha
 */
public class Reg_MLO_MAM_Screen_SuperUser_Add_Delete_Delegate_ModifyDate extends BaseWebDriver {
	...
	public void verifyOrderApprovedWithSuperUser() throws Throwable {
		...
		OrderingManagerApprovalMaintenancePage.addDelegate();
		OrderingManagerApprovalMaintenancePage.removeDelegate();
		OrderingManagerApprovalMaintenancePage.clickOnSaveButton();
