 ...
 * @lastModifiedBy usha
 */
public class Reg_MLO_MAM_Screen_SuperUser_MultipleApprover_Reject_SingleOrder extends BaseWebDriver {
	...
	public void verifyOrderApprovedWithSperUser() throws Throwable {
		...
		OrderingManagerApprovalMaintenancePage.openOrderInManagerApprovalMaintenance();
		...
		OrderingManagerApprovalMaintenancePage.moveBackToManagerApprovalMaintenancePage("Save & Leave");
		OrderingMyOrdersPage.enterTextInLogNumberSearchFieldFO(CommonPage.getTestData("LoggerLogNumber"+"1"));
		OrderingMyOrdersPage.clickOnSearch();
	...
	public void verifyOrdersNotVisibleWithApprover1() throws Throwable {
	...
	@Test(dependsOnMethods = "verifyOrdersNotVisibleWithApprover1")
	@Documentation(step = "Approver User should not see orders in Manager Approval Queue", expected = "Approver User is not see orders in Manager Approval Queue")
	public void verifyOrdersNotVisibleWithApprover2() throws Throwable {
	...
	@Test(dependsOnMethods = "verifyOrdersNotVisibleWithApprover2")
	@Documentation(step = "Open Back office page from Super User", expected = "Back office page should be opened from Super User")
