 ...
 * @lastModifiedBy usha
 */
public class Reg_MLO_MAM_Screen_SuperUser_SingleApprover_Reject_SingleOrder extends BaseWebDriver {
	...
	@Documentation(step = "Super User Reject the order", expected = "Order should be rejected by Super User and order should be removed from list")
	public void verifyOrderRejectWithSuperUser() throws Throwable {
		...
		OrderingManagerApprovalMaintenancePage.aproveOrRejectOrder("Reject - On Behalf Of Super User");
	...
	@Test(dependsOnMethods="verifyOrderRejectWithSuperUser")
	...
	@Documentation(step = "Approver User should not see orders in Manager Approval Queue", expected = "Approver User is not see orders in Manager Approval Queue")
	public void verifyOrdersNotVisibleWithApprover() throws Throwable {
		OrderingLoginPage.openCustomFOApplication(CommonPage.getTestData("ApproverID"));
		OrderingHomePage.waitForHomePage();
		OrderingHomePage.selectSideMenuOption("Ordering");
	...
	@Test(dependsOnMethods = "verifyOrdersNotVisibleWithApprover")
	@Documentation(step = "Open Back office page from Super User", expected = "Back office page should be opened from Super User")
	public void moveToBOURLFromSuperUser() throws Exception {
		OrderingLoginPage.openBOApplication();
	}

	@Test(dependsOnMethods = "moveToBOURLFromSuperUser")
	@Documentation(step = "Enter the valid username and password to login to the application", expected = "The application home page should be displayed after successful login")
	public void loginToBOApplication() throws Exception {
		OrderingBOHomePage.orderingBOHomePageLoaded();
	}
	
	@Test(dependsOnMethods = "loginToBOApplication")
	@Documentation(step = "Go to On Order Queue page and verify logger order are not displayed", expected = "Application should load On Order Queue page and verified logger order are not displayed ")
	public void goToOnOrderQueueAndVerifyLoggerOrderIsNotDisplayed() throws Throwable {
		OrderingBOManagerOrderPreferencesPage.verifyOrdersNotDisplayedInOnOrderQueues();
	}
	
	@Test(dependsOnMethods = "goToOnOrderQueueAndVerifyLoggerOrderIsNotDisplayed")
	@Documentation(step = "Click on Logout button from SU", expected = "Application should be logged out")
	public void bOLogOutUsingSuperUser() throws Exception {
		OrderingBOHomePage.verifyLogOutFunctionality();
	}
	
	@Test(dependsOnMethods="bOLogOutUsingSuperUser")
	...
	public void verifyOrderApprovedWithSuperUser() throws Throwable {
	...
	@Test(dependsOnMethods="verifyOrderApprovedWithSuperUser")
