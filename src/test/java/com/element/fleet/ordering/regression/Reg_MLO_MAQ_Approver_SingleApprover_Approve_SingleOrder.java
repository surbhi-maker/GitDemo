 ...
 * @lastModifiedBy usha
 */
public class Reg_MLO_MAQ_Approver_SingleApprover_Approve_SingleOrder extends BaseWebDriver {
	...
	@Documentation(step = "Approver User approves the order", expected = " Order should be approved by Approver User and order should be removed from list")
	public void verifySelectedOrderApprovedWithFirstApprover() throws Throwable {
		...
		OrderingManagerApprovalQueuePage.verifyPopUpMessage("Single Logger Approval", CommonPage.getTestData("LoggerLogNumber"+1));
	...
	@Test(dependsOnMethods = "verifySelectedOrderApprovedWithFirstApprover")
