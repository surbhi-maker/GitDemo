 ...
 */
public class Reg_MLO_MAQ_SuperUser_Reject_Bulk_Order extends BaseWebDriver {
	...
	public void verifyOrdersRejectedWithSperUser() throws Throwable {
		OrderingManagerApprovalQueuePage.bulkOrSingleActionOnOrder(CommonPage.getTestData("Username"), "Bulk", "Reject", false);
	}
	
	@Test(dependsOnMethods = "verifyOrdersRejectedWithSperUser")
