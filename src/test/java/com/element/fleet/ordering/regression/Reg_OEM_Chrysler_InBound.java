 ...
 */
public class Reg_OEM_Chrysler_InBound extends BaseWebDriver {
	...
	@Documentation(step = "Go to On Order Queue page and set DOE toggle to Yes", expected = "Application should load On Order Queue page and DOE toggle should be set to Yes")
	...
	public void goToAcknowledgeQueuePage() throws Throwable {
		...
		OrderingBOOrdMaintPage.verifyChangedOrderStatus(CommonPage.getTestData("CustomColumn3"));
	}
