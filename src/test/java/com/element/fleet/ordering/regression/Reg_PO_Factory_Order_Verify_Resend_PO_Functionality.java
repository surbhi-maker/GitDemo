 ...
 */
public class Reg_PO_Factory_Order_Verify_Resend_PO_Functionality extends BaseWebDriver {
	...
	public void clickSendPONowAndSendPOEmail() throws Exception {
		...
		OrderingBOOrdMaintPage.setEmailSubjectLine("Resend PO");
		...
		OrderingBOOrdMaintPage.setCurrentPOStatus("Purchase Order Sent To Upfitter");
	}
	
	@Test(dependsOnMethods = "clickSendPONowAndSendPOEmail")	
	@Documentation(step = "Validate Details on Email Popup with order details", expected = "Email Popup Details should be as expected")
	...
	@Documentation(step = "Validate Emails in CC field are autopopulated as per initially sent email", expected = "Emails in CC field should be autopopulated as per initially sent email")
	public void validateEmailInCCField() throws Exception {
		OrderingBOOrdMaintPage.validateEmailInCCField();
	}
	
	@Test(dependsOnMethods = "validateEmailInCCField")	
	@Documentation(step = "Validate additional text is autopopulated as per initially sent email", expected = "Additional text should be autopopulated as per initially sent email")
	public void validateAddtionalText() throws Exception {
		OrderingBOOrdMaintPage.validateAdditionalTextSentInEarlierEmail();
	}
	
	@Test(dependsOnMethods = "validateAddtionalText")	
	...
	@Documentation(step = "Validate details in PDF Attachment", expected = "PDF Attachment details should be as expected")
	...
	@Documentation(step = "Validate user is able to send Email By clicking on Send button", expected = "Email should be sent on clicking Send button")
	...
	@Documentation(step = "Validate PO status changes to Purchase Order Sent to Upfitter", expected = "PO Status should change to Purchase Order Sent to Upfitter")
