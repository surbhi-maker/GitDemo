 ...
 */
public class Reg_PriceAndConfig_Incentive_PriceProtection extends BaseWebDriver{
	...
	public void varifyDaseAndDestinationFeePriceLabelAreInGreen() throws Exception{
		OrderingFOFleetSpecDetailsPage.verifyColorForBaseAndDestinationFeeLabels("#82C341"); 
	}

	@Test(alwaysRun = true, dependsOnMethods = "varifyDaseAndDestinationFeePriceLabelAreInGreen")
