 ...
 */
public class Reg_TitleRegQueue_Search_Sort_ToggleColumn_ClearFilter_Export extends BaseWebDriver {
	...
	public void verifyExportTableData() throws Throwable {
		OrderingSummaryPage.clickExportButton("TitleRegQueue", this.getClass().getSimpleName());
	}
	...
	public void verifyColumnSortedInDescAscOrder() throws Exception {
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Log", "TitleRegQueue");
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Log", "TitleRegQueue" );
		OrderingBOOnOrderQueuePage.compareOrderOfColumn("Log", "Ascending" , "TitleRegQueue");
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Client", "TitleRegQueue");
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Client", "TitleRegQueue" );
		OrderingBOOnOrderQueuePage.compareOrderOfColumn("Client", "Ascending" , "TitleRegQueue");
	}
	...
	public void verifyTitleRegQueuePageSearchAndSortFunctionality() throws Throwable {
		OrderingBOQueuePage.verifyReleaseButton(true);
		OrderingBOQueuePage.searchAndVerifyRecords("Standard Search", "Client", "17595");
	}
	
	@Test(dependsOnMethods = "verifyTitleRegQueuePageSearchAndSortFunctionality")
	...
	public void verifyToggleColumnsAndTableColumns() throws Throwable {
		...
		OrderingBOQueuePage.removeColumnsFromQueueTable("Log","Corp", "Title", "State");
		OrderingBOQueuePage.verifyQueueTableColumns();
		OrderingBOQueuePage.addColumnInQueueTable("Log","Corp", "Title", "State");
		OrderingBOQueuePage.verifyQueueTableColumns();
	}
	...
	@Test(dependsOnMethods = "verifyPagenationTitleRegqueue", alwaysRun = true)
