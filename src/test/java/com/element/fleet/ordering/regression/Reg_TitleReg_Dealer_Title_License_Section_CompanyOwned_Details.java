 ...
 */
public class Reg_TitleReg_Dealer_Title_License_Section_CompanyOwned_Details extends BaseWebDriver{
	@BeforeClass
	...
	@Documentation(step = "Select order type on create order page", expected = "Order type should be Dealer Order")
	...
	public void verifyLienholderInformationSectionCanBeEditedInBO() throws Throwable {
	...
	public void  verifyVehicleWillBeTitledAndRegisteredInStatementIsPresentWithStateNameForUSclientInBO() throws Throwable {
		OrderingBOOrdMaintPage.goToTitleAndRegistrationTab();
		OrderingBOOrdMaintPage.verifyVehicleRegisteredTextMatchesWithBillingPageText(CommonPage.getElementOrderObject());
		OrderingBOOrdMaintPage.verifyEditedTitleInfoMatches();
		OrderingBOOrdMaintPage.verifyEditedRegistrationInfoMatches();	
	}
