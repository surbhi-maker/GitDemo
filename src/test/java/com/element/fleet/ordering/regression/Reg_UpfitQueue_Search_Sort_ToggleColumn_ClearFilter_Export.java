 ...
 */
public class Reg_UpfitQueue_Search_Sort_ToggleColumn_ClearFilter_Export extends BaseWebDriver {
	...
	public void verifyUpfitQueuePageSearchAndSortFunctionality() throws Throwable {
		OrderingBOQueuePage.verifyReleaseButton(true);
		OrderingBOQueuePage.searchAndVerifyRecords("Standard Search", "Client", "17595");
	}
	
	@Test(dependsOnMethods = "verifyUpfitQueuePageSearchAndSortFunctionality")
	...
	public void verifyExportTableData() throws Throwable {
		OrderingSummaryPage.clickExportButton("UpfitQueue", this.getClass().getSimpleName());
	}
	...
	public void verifyColumnSortedInDescAscOrder() throws Exception {
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Log", "UpfitQueue");
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Log", "UpfitQueue" );
		OrderingBOOnOrderQueuePage.compareOrderOfColumn("Log", "Ascending" , "UpfitQueue");
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Client", "UpfitQueue");
		OrderingBOOnOrderQueuePage.clickColumnTableHeading("Client", "UpfitQueue" );
		OrderingBOOnOrderQueuePage.compareOrderOfColumn("Client", "Ascending" , "UpfitQueue");
	}
